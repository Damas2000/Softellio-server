...
const dns_verification_util_1 = require("./dns-verification.util");
...
describe('DnsVerificationUtil', () => {
    let service;
    beforeEach(() => {
        service = new dns_verification_util_1.DnsVerificationUtil();
        jest.clearAllMocks();
    });
    ...
    describe('verifyDomainOwnership', () => {
        ...
        it('should handle ENODATA DNS error', async () => {
            const dnsError = new Error('No data');
        ...
        it('should handle ETIMEOUT DNS error', async () => {
            const dnsError = new Error('Timeout');
        ...
        it('should handle unknown DNS errors', async () => {
            const dnsError = new Error('Unknown error');
...
//# sourceMappingURL=dns-verification.util.spec.js.map