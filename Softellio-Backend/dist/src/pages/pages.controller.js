...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: bulk_delete_dto_1.BulkDeleteDto, description: 'Array of page IDs to delete' }),
    (0, swagger_1.ApiResponse)({ status: 200, type: bulk_delete_dto_1.BulkDeleteResponseDto, description: 'Pages deleted successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Validation error' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_tenant_decorator_1.CurrentTenant)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [bulk_delete_dto_1.BulkDeleteDto, Number, Object]),
    __metadata("design:returntype", Promise)
