...
describe('PrismaExceptionFilter', () => {
    ...
    beforeEach(() => {
        filter = new prisma_exception_filter_1.PrismaExceptionFilter();
        mockResponse = {
    ...
    describe('P2002 - Unique Constraint Violation', () => {
        it('should return 409 status with email conflict message', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Unique constraint failed', {
                code: 'P2002',
                clientVersion: '5.0.0',
                meta: { target: ['email'] },
            });
    ...
    describe('P2003 - Foreign Key Constraint Violation', () => {
        it('should return 400 status with page reference error', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Foreign key constraint failed', {
                code: 'P2003',
                clientVersion: '5.0.0',
    ...
    describe('P2025 - Record Not Found', () => {
        it('should return 404 status with not found message', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Record not found', {
                code: 'P2025',
                clientVersion: '5.0.0',
                meta: {},
            });
    ...
    describe('P2014 - Invalid Field Value', () => {
        it('should return 400 status with field validation error', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Invalid value for field', {
                code: 'P2014',
                clientVersion: '5.0.0',
                meta: { target: 'email' },
            });
    ...
    describe('P2034 - Transaction Conflict', () => {
        it('should return 409 status with transaction conflict message', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Transaction conflict', {
                code: 'P2034',
                clientVersion: '5.0.0',
                meta: {},
            });
    ...
    describe('Unknown Prisma Error Codes', () => {
        it('should return 500 status with generic error message for unknown codes', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Unknown prisma error', {
                code: 'P9999',
                clientVersion: '5.0.0',
                meta: {},
            });
    ...
    describe('Response Format', () => {
        it('should include all required fields in error response', () => {
            const exception = new library_1.PrismaClientKnownRequestError('Test error', {
                code: 'P2002',
                clientVersion: '5.0.0',
                meta: { target: ['email'] },
            });
