...
import { CreateServiceDto, UpdateServiceDto, ServiceQueryDto, ServiceReorderDto } from './dto/service.dto';
...
export declare class ServicesController {
    ...
    reorder(reorderDto: ServiceReorderDto, tenantId: number): Promise<void>;
