...
exports.ServiceOrderDto = exports.ServiceReorderDto = exports.BulkServiceDeleteDto = exports.ServiceQueryDto = exports.UpdateServiceDto = exports.CreateServiceDto = exports.ServiceTranslationDto = void 0;
...
class BulkServiceDeleteDto {
}
exports.BulkServiceDeleteDto = BulkServiceDeleteDto;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.ArrayMinSize)(1, { message: 'At least one service ID is required' }),
    (0, class_validator_1.IsInt)({ each: true, message: 'Each ID must be a valid integer' }),
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Array)
], BulkServiceDeleteDto.prototype, "ids", void 0);
class ServiceReorderDto {
}
exports.ServiceReorderDto = ServiceReorderDto;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_1.ArrayMinSize)(1, { message: 'At least one service is required' }),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => ServiceOrderDto),
    __metadata("design:type", Array)
], ServiceReorderDto.prototype, "services", void 0);
class ServiceOrderDto {
}
exports.ServiceOrderDto = ServiceOrderDto;
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], ServiceOrderDto.prototype, "id", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], ServiceOrderDto.prototype, "order", void 0);
