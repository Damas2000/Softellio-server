...
let ReferencesController = class ReferencesController {
    ...
    bulkDeleteDeprecated(body) {
        throw new common_1.GoneException('This endpoint is deprecated. Use POST /references/admin/bulk-delete');
    }
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: bulk_delete_dto_1.BulkDeleteDto, description: 'Array of reference IDs to delete' }),
    (0, swagger_1.ApiResponse)({ status: 200, type: bulk_delete_dto_1.BulkDeleteResponseDto, description: 'References deleted successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Validation error' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, current_tenant_decorator_1.CurrentTenant)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReferencesController.prototype, "bulkDeleteDeprecated", null);
__decorate([
