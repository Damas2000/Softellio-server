...
exports.DomainsModule = DomainsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [domains_service_1.DomainsService, dns_verification_util_1.DnsVerificationUtil],
        exports: [domains_service_1.DomainsService, dns_verification_util_1.DnsVerificationUtil],
    })
], DomainsModule);
