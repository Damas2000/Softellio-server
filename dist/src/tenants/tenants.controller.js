...
const create_tenant_with_domains_dto_1 = require("./dto/create-tenant-with-domains.dto");
...
let TenantsController = class TenantsController {
    ...
    createWithDomains(createTenantDto) {
...
__decorate([
    (0, common_1.Post)('create-with-domains'),
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Company name/slug already exists' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_tenant_with_domains_dto_1.CreateTenantWithDomainsDto]),
    __metadata("design:returntype", void 0)
], TenantsController.prototype, "createWithDomains", null);
__decorate([
    (0, common_1.Get)(),
