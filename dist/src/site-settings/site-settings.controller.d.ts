...
import { CreateSiteSettingDto, UpdateSiteSettingDto, UpsertSiteSettingTranslationDto } from './dto/site-setting.dto';
export declare class SiteSettingsController {
    ...
    upsertTranslation(language: string, translationDto: UpsertSiteSettingTranslationDto, tenantId: number): Promise<import("./site-settings.service").SiteSettingWithTranslations>;
