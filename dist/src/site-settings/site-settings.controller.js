...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid request body or missing required fields' }),
    __param(0, (0, common_1.Param)('language')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, current_tenant_decorator_1.CurrentTenant)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, site_setting_dto_1.UpsertSiteSettingTranslationDto, Number]),
    __metadata("design:returntype", void 0)
